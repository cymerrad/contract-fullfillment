...
var ZombieArtifact = require('../build/contracts/ZombieOwnership.json');
var Zombie = truffle_contract_1.default(ZombieArtifact);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                addresses = _a.sent();
                addr = addresses[0];
                Zombie.deployed().then(function (instance) {
